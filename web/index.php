...
$app->get('/cancel/:timestamp', function ($timestamp) use ($app, $con) {
  ...
  sendEmail('Boardroom Scheduler', 
    'admin@boardroom.work', 
...
$app->post('/schedule', function () use ($app, $con, $opentok) {
  ...
  sendEmail('Boardroom Scheduler', 'admin@boardroom.work', $name, $email, "Your TokBox appointment on " .$timestring, "You are confirmed for your appointment on " .$timestring. ". On the day of your appointment, go here: ".getBaseURL()."/index.php/chat/" .$sessionId);
